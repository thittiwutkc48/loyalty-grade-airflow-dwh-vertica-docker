...
from daily.customer.daily_dtac_customers_stg_to_stg_sgv.default_config import default_config
from daily.customer.daily_dtac_customers_stg_to_stg_sgv.sql.sql_query import (
    extract_to_staging,
...
with DAG(
    dag_id="daily_dtac_customers_stg_to_stg_sgv",
