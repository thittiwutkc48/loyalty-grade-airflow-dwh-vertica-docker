...
from daily.revenue.daily_dtac_balances_stg_to_sgv.default_config import default_config
from daily.revenue.daily_dtac_balances_stg_to_sgv.sql.sql_query import (
    extract_to_staging,
...
with DAG(
    dag_id="daily_dtac_balances_stg_to_sgv",
    default_args=default_args,
    description="Extract and process daily balance data from the DTAC system.",
