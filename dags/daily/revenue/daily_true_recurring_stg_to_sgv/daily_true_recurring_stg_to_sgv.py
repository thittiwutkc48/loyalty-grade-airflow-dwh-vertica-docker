...
from daily.revenue.daily_true_recurring_stg_to_sgv.default_config import default_config
from daily.revenue.daily_true_recurring_stg_to_sgv.sql.sql_query import (
    extract_to_staging,
...
with DAG(
    dag_id="daily_true_recurring_stg_to_sgv",
    default_args=default_args,
    description="Extract and process daily topping recurring data from the TRUE system.",
