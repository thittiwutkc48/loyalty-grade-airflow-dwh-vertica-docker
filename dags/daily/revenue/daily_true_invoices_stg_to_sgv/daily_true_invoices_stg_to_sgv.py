...
from daily.revenue.daily_true_invoices_stg_to_sgv.default_config import default_config
from daily.revenue.daily_true_invoices_stg_to_sgv.sql.sql_query import (
    extract_to_staging,
    validate_json,
...
with DAG(
    dag_id="daily_true_invoices_stg_to_sgv",
    ...
    delete_duplicates_staging_task >> extract_to_staging_task >> validate_json_task >> delete_duplicates_single_view_task >> transform_to_single_view_task
