...
from daily.subscriber.daily_true_subscribers_stg_to_sgv.sql.sql_query import (
    ...
    insert_temp_product_id_inactive,
...
with DAG(
    ...
    insert_temp_product_id_inactive_task = VerticaOperator(
        task_id="insert_temp_product_id_inactive_task",
        vertica_conn_id="vertica_conn",
        sql=Template(insert_temp_product_id_inactive).render(sql_context),
    )
    ...
    delete_duplicates_staging_task >> extract_to_staging_task >> validate_json_task >> extract_to_staging_product_task >> transform_inactive_to_single_view_task >> insert_temp_product_id_inactive_task >>update_product_id_in_temp_inactive_task >> insert_to_product_history_task >> delete_inactive_in_single_view_task >> transform_non_inactive_to_single_view_task
