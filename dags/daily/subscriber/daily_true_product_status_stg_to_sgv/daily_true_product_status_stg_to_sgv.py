...
from daily.subscriber.daily_true_product_status_stg_to_sgv.default_config import default_config
from daily.subscriber.daily_true_product_status_stg_to_sgv.sql.sql_query import (
    extract_to_staging,
    validate_json,
...
with DAG(
    dag_id="daily_true_product_status_stg_to_sgv",
    default_args=default_args,
    description="Extract and process daily product status data from the TRUE system.",
    ...
    delete_duplicates_staging_task >> extract_to_staging_task >> validate_json_task >> transform_to_single_view_task
