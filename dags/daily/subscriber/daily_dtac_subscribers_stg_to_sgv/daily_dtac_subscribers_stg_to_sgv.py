...
with DAG(
    ...
    delete_duplicates_staging_task >> extract_to_staging_task >> delete_duplicates_single_staging_task >>transform_to_single_staging_task >> transform_to_unmatched_single_staging_task >> transform_to_single_view_task
