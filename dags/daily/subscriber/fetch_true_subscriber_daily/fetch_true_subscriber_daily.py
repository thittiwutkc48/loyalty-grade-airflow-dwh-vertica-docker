...
from daily.subscriber.fetch_true_subscriber_daily.default_config import default_config
from daily.subscriber.fetch_true_subscriber_daily.sql.sql_query import (
    extract_to_staging,
...
with DAG(
    dag_id="fetch_true_subscriber_daily",
