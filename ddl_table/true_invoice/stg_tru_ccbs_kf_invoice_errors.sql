...
PARTITION BY (stg_tru_ccbs_kf_invoice_errors.vc_par_key);


CREATE PROJECTION CLYMAPPO.stg_tru_ccbs_kf_invoice_errors_super /*+basename(stg_tru_ccbs_kf_invoice_errors),createtype(P)*/ 
(
 rowkey,
 topic,
 raw,
