...
CREATE PROJECTION CLYMAPPO.stg_tru_crm_kf_customer_errors_super  
(
    rowkey,
    topic,
    raw,
...
AS
SELECT 
    stg_tru_crm_kf_customer_errors.rowkey,
...
FROM 
    CLYMAPPO.stg_tru_crm_kf_customer_errors
ORDER BY 
    stg_tru_crm_kf_customer_errors.rowkey,
    stg_tru_crm_kf_customer_errors.topic,
    stg_tru_crm_kf_customer_errors.raw,
    ...
    stg_tru_crm_kf_customer_errors.header
SEGMENTED BY 
    hash(stg_tru_crm_kf_customer_errors.vc_par_key, stg_tru_crm_kf_customer_errors.vc_syn_date) 
ALL NODES;
